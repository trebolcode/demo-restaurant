...
const Reservation = () => {
  return (
  <section className="bg-[url('/src/assets/img/bgAbout.jpg')] bg-cover bg-bottom py-[70px] flex w-full h-auto justify-center">
  		  ...
  		  <div className="px-[15px]">
  			  <img src={imgAbout} alt="" className="w-[100%] h-[438.75px] shadow-[20px_20px_0px_0px_rgba(214,81,6,1)]" />
  		  </div>
  </section>
    )
  } 
